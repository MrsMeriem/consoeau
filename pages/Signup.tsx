          ...
          {step === 3 && (
            <div className="space-y-8">
              <div className="bg-blue-500/10 p-6 rounded-3xl border border-blue-500/20 text-center">
                 ...
                 <p className="text-slate-400 text-[11px] mt-2 font-medium leading-relaxed">Le code se trouve au dos de votre passerelle ConsoEau ou sur votre guide d'installation.</p>
              </div>
              <div className="relative">
